...
<p align="center">
  ...
  <a href="https://github.com/i-saurabha-23" target="_blank">
...
- **Tech Stack:** Next.js, Node.js, MongoDB, PDF generation
...
| Achievement | Impact |
|---|---|
| **2+ Lakh** | Website traffic generated (E-Learning Platform, 1 month) |
| **500+** | Target MSME businesses for Udyam Saral |
| **3** | Production-ready SaaS platforms deployed |
| **100%** | Uptime on Firebase-hosted applications |
| **Real-time** | Data sync across multi-user platforms |
...
- **Campus Ambassador** - Promoted emerging tech concepts (green hydrogen, fintech, automation)
